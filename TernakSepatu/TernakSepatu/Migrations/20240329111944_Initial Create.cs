...
namespace TernakSepatu.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        VALUES (1, 'admin', 'ADMIN', '" + Guid.NewGuid().ToString() + @"');

        INSERT INTO AspNetRoles (Id, Name, NormalizedName, ConcurrencyStamp)
        VALUES (2, 'costumer', 'COSTUMER', '" + Guid.NewGuid().ToString() + @"');
    ");
    ...
    constraints: table =>
    {
     ...
     columns: table => new
     {
         ...
         user_id = table.Column<string>(type: "nvarchar(450)", nullable: true) // or int based on your user id type
     },
     constraints: table =>
     {
         table.PrimaryKey("PK_address_info", x => x.Id);
         table.ForeignKey(
             name: "FK_address_info_AspNetUsers_user_id",
             column: x => x.user_id,
